...
#scramble
sss = StratifiedShuffleSplit(10,test_size=0.8, random_state = 15)
...
label = ['temor', 'otros', 'bienvenida', 'otros2', 'juego2', 'paseo', 'muy agresivo', 'agresivo', 'peligroso',
